...
public:
  void Calculate()
  {
    ...
    cout << "\t|"
         << " 1.  |"
         << "  Husband                  |\t" << P_H << "\t|\t" << S_H << "\t|\t" << R_H << "\t|" << endl;
    cout << "\t|"
         << " 2.  |"
         << "  Wife                     |\t" << P_W << "\t|\t" << S_W << "\t|\t" << R_W << "\t|" << endl;
    cout << "\t|"
         << " 3.  |"
         << "  Father                   |\t" << P_F << "\t|\t" << S_F << "\t|\t" << R_F << "\t|" << endl;
    cout << "\t|"
         << " 3.  |"
         << "  Father's Father          |\t" << P_FF << "\t|\t" << S_FF << "\t|\t" << R_FF << "\t|" << endl;
    cout << "\t|"
         << " 4.  |"
         << "  Mother                   |\t" << P_M << "\t|\t" << S_M << "\t|\t" << R_M << "\t|" << endl;
    cout << "\t|"
         << " 5.  |"
         << "  Son                      |\t" << P_S << "\t|\t" << S_S << "\t|\t" << R_S << "\t|" << endl;
    cout << "\t|"
         << " 6.  |"
         << "  Son's Son                |\t" << P_SS << "\t|\t" << S_SS << "\t|\t" << R_SS << "\t|" << endl;
    cout << "\t|"
         << " 7.  |"
         << "  Son's Son's Son          |\t" << P_SSS << "\t|\t" << S_SSS << "\t|\t" << R_SSS << "\t|" << endl;
    cout << "\t|"
         << " 8.  |"
         << "  Daughter                 |\t" << P_D << "\t|\t" << S_D << "\t|\t" << R_D << "\t|" << endl;
    cout << "\t|"
         << " 9.  |"
         << "  Son's Daughter           |\t" << P_SD << "\t|\t" << S_SD << "\t|\t" << R_SD << "\t|" << endl;
    cout << "\t|"
         << " 10. |"
         << "  Son's Son's Daughter     |\t" << P_SSD << "\t|\t" << S_SSD << "\t|\t" << R_SSD << "\t|" << endl;
    cout << "\t|"
         << " 11. |"
         << "  Real Brother             |\t" << P_RB << "\t|\t" << S_RB << "\t|\t" << R_RB << "\t|" << endl;
    cout << "\t|"
         << " 12. |"
         << "  Real Sister              |\t" << P_RS << "\t|\t" << S_RS << "\t|\t" << R_RS << "\t|" << endl;
    cout << "\t|"
         << " 13. |"
         << "  Paternal Brother         |\t" << P_PB << "\t|\t" << S_PB << "\t|\t" << R_PB << "\t|" << endl;
    cout << "\t|"
         << " 14. |"
         << "  Paternal Sister          |\t" << P_PS << "\t|\t" << S_PS << "\t|\t" << R_PS << "\t|" << endl;
    cout << "\t|"
         << " 15. |"
         << "  Maternal Brother         |\t" << P_MB << "\t|\t" << S_MB << "\t|\t" << R_MB << "\t|" << endl;
    cout << "\t|"
         << " 16. |"
         << "  Maternal Sister          |\t" << P_MS << "\t|\t" << S_MS << "\t|\t" << R_MS << "\t|" << endl;
    cout << "\t|-------------------------------------------------------------------------------|" << endl;
    cout << endl;
    cout << endl;
